...
namespace WhiteTea.HotfixLogic
{
    ...
    public sealed class Fsm:FsmBase, IFsm
    {
        ...
        public void Start<TState>( ) where TState : FsmState
        {
            ...
            if(state == null)
            {
                throw new GameFrameworkException(Utility.Text.Format("FSM '{0}' can not start state '{1}' which is not exist." , Name , typeof(TState).FullName));
            }
        ...
        public void Start(Type stateType)
        {
            ...
            if(state == null)
            {
                throw new GameFrameworkException(Utility.Text.Format("FSM '{0}' can not start state '{1}' which is not exist." , Name , stateType.FullName));
            }
        ...
        internal void ChangeState(Type stateType)
        {
            ...
            if(state == null)
            {
                throw new GameFrameworkException(Utility.Text.Format("FSM '{0}' can not change state to '{1}' which is not exist." , Name , stateType.FullName));
            }
